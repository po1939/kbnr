  ...
  const entreeItems = [
    {
      ...
      icon: VeganIcon,
      secondIcon: SpicyIcon,
      description: 'Fried rice with kimchi, vegetables and ham topped with fried egg and seaweed flakes',
      price: '$12.99',
    },
    {
    ...
    },
    {
      ...
      label: 'Omurice',
      icon: VeganIcon,
      description: 'Fried rice with ham and vegetables wrapped in a thin layer of egg topped with ketchup',
      price: '$12.99',
    },
    {
      image: JeyookDupbap,
      label: 'Jeyook Dupbap',
      icon: SpicyIcon,
      description: 'Spicy stir-fried pork with vegetables served with steamed rice',
      price: '$14.50',
    },
    {
      image: BulgogiDupbap,
      label: 'Bulgogi Dupbap',
      description: 'Soy sauce marinated beef with vegetables served with steamed rice',
      price: '$17.50',
    },
    {
      image: SquidDupbap,
      label: 'Squid Dupbap',
      icon: SpicyIcon,
      description: 'Spicy stir-fried squid with vegetables served with steamed rice',
      price: '$14.50',
    },
    {
      image: OctopusDupbap,
      ...
      icon: SpicyIcon,
      description: 'Spicy stir-fried octopus with vegetables served with steamed rice',
      price: '$15.50',
    },
    {
      image: KimchiStew,
      label: 'Kimchi Stew',
      icon: SpicyIcon,
      description: 'Spicy kimchi stew with tofu, pork, spam, and vegetables served with steamed rice',
      price: '$13.99',
    },
    {
      ...
      icon: VeganIcon,
      description: 'Soy Bean Paste Stew with tofu, seafood, and vegetables served with steamed rice',
      price: '$13.99',
    },
    {
      image: TofuStew,
      ...
      icon: VeganIcon,
      secondIcon: SpicyIcon,
      description: 'Spicy soft tofu stew with seafood and vegetables served with steamed rice',
      price: '$13.99',
    },
    {
      image: YookGaeJang,
    ...
    },
    {
      ...
      icon: VeganIcon,
      secondIcon: SpicyIcon,
      description: 'Assorted vegetables, beef, fried egg, and seaweed flaskes served on rice with spicy pepper paste',
      price: '$12.99',
    },
    {
      ...
      icon: VeganIcon,
      secondIcon: SpicyIcon,
      description: 'Assorted vegetables, beef, fried egg, and seaweed flaskes served on rice with spicy pepper paste in a sizzling hot stone pot',
      price: '$13.99',
    },                                                
  ];
const noodleItems = [
  ...
  },
  {
    ...
    label: 'Udon',
    icon: VeganIcon,
    description: 'Japanese style noodle soup with fishcakes and vegetables. Topped with seaweed flakes',
    price: '$11.50',
  },
  {
    image: TempuraUdon,
  ...
  },
  {
    ...
    label: 'Janchi Guksu',
    icon: VeganIcon,
    description: 'Warm noodle soup in anchovy broth with vegetables, egg, and seaweed flakes',
    price: '$12.99',
  },
  {
    image: KongGuksu,
    label: 'Kong-Guksu',
    icon: VeganIcon,
    description: 'Noodles in cold soup made from ground soy bean, sesame, and pine nut topped with egg and cucumber',
    price: '$12.99',
  },
  {
    image: MulNaengmyun,
    label: 'Mul Naengmyun',
    description: 'Buckwheat noodle in cold beef broth. Topped with beef, egg, and vegetables',
    price: '$12.50',
  },
  {
    ...
    icon: SpicyIcon,
    description: 'Buckwheat noodle in cold beef broth. Topped with spicy sauce, beef, egg, and vegetables',
    price: '$12.99',
  },
]
const boonsikItems = [
  {
    ...
    icon: VeganIcon,
    secondIcon: SpicyIcon,
    description: 'Korean style spicy rice cakes with fishcakes, egg, and vegetables',
    price: '$12.50',
  },
  {
    image: Rabokyi,
  ...
  },
  {
    ...
    label: 'Sujebi',
    icon: VeganIcon,
    description: 'Handtorn dough flake soup with clam, potatoes, and vegetables',
    price: '$12.50',
  },
  {
    image: KimchiSujebi,
    ...
    icon: VeganIcon,
    secondIcon: SpicyIcon,
    description: 'Handtorn dough flake soup with kimchi, clam, potatoes, and vegetables',
    price: '$12.99',
  },
  {
    image: RiceCakeSoup,
    ...
    icon: VeganIcon,
    description: 'Sliced rice cake soup with egg, glass noodles, and vegetables. Topped with seaweed flakes',
    price: '$11.99',
  },
  {
    image: DumplingSoup,
    label: 'Dumpling Soup',
    description: 'Meat dumpling soup with egg, glass noodles, and vegetables. Topped with seaweed flakes',
    price: '$12.99',
  },
  {
    image: RiceCakeDumplingSoup,
    label: 'Rice Cake Dumpling Soup',
    description: 'Sliced rice cake soup with meat dumplings, glass noodles, eggs, and vegetables. Topped with seaweed flakes',
    price: '$12.99',
  },
  {
    image: Donkatsu,
  ...
  return (
    <div className="menu">
      ...
      <div className='menu-content'>
        ...
        <section id="entree">
          <h6>Entree</h6>
          <p>Our entree section consists of a variety of "Hansik" (한식) items which refers to traditional Korean cuisine. It encompasses a rich variety of dishes that have evolved over centuries, influenced by the unique geography, climate, and cultural history of the Korean Peninsula. Hansik is known for its emphasis on balance, color, and seasonality, as well as its use of diverse ingredients.
          </p>
          <MenuItemCard items={entreeItems} />
        </section>
        <section id="noodle">
          <h6>Noodles</h6>
          <p>Indulge in the rich and savory world of Korean noodle dishes, where every bite is a balance of comfort and flavor. From variations of the widely loved Korean style ramen to the refreshing and tangy bite of our chilled noodles like Mul Naengmyeon and Bibim Naengmyeon, there's something for every craving. Whether you're in the mood for a hearty, steaming bowl or a cool, invigorating meal, our noodle selection, made with fresh ingredients and traditional recipes, brings the best of Korea’s noodle dishes to your table.
          </p>
          <MenuItemCard items={noodleItems} />
        </section>
        <section id="boonsik">
          <h6>Boonsik</h6>
          <p>"Boonsik" (분식) refers to a category of Korean street food that includes various snacks and light meals. Boonsik is a combination of two Korean words: "bun" (분), meaning powder or flour, and "sik" (식), meaning food. These snacks are often affordable, quick to prepare, and popular among people of all ages.
          </p>
